...
import type { EmailService } from '../domain/types';
import { UnosendEmailService } from './adapters/unosend';
import { MailgunEmailService } from './adapters/mailgun';
import { ResendEmailService } from './adapters/resend';

export type { EmailService, SendEmailOptions, SendEmailResult } from '../domain/types';
export { UnosendEmailService } from './adapters/unosend';
export { MailgunEmailService } from './adapters/mailgun';
export { ResendEmailService } from './adapters/resend';
