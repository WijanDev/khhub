...
import { createDb, Database } from '@shared/infrastructure/db/index';
import { createMockD1 } from '../../../test-utils/setup';
...
describe('Database', () => {
  ...
  describe('Schema re-exports', () => {
    it('should re-export schema tables', async () => {
      const dbModule = await import('../../../../src/shared/infrastructure/db/index');
