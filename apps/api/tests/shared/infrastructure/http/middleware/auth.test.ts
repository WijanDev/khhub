...
import { authMiddleware, requireAuth, requireAdmin } from '@shared/infrastructure/http/middleware/auth';
import type { AuthSession } from '@shared/domain/types';
import { createMockEnv } from '../../../../test-utils/setup';

const mockGetSession = vi.fn();

vi.mock('../../../../../src/features/auth/infrastructure/better-auth', () => ({
  getAuth: vi.fn(() => ({
    api: {
...
describe('authMiddleware', () => {
  ...
  beforeEach(() => {
    ...
    mockNext = vi.fn().mockResolvedValue(undefined) as unknown as any;
