...
import usersRoutes from '@users/infrastructure/http/router';
...
vi.mock('../../../../../src/features/email/service', async () => {
  const actual = await vi.importActual('../../../../../src/features/email/service');
  return {
    ...actual,
