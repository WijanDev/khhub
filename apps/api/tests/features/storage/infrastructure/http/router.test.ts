...
import storageRoutes from '@storage/infrastructure/http/router';
import { createMockEnv } from '@tests/test-utils/setup';
...
vi.mock('@storage/infrastructure/r2-storage', async () => {
  const actual = await vi.importActual('@storage/infrastructure/r2-storage');
  return {
    ...actual,
