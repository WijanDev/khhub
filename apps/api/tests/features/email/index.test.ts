...
import {
  ...
  MailgunEmailService,
  ResendEmailService,
} from '@email/infrastructure/factory';

vi.mock('../../../src/features/email/infrastructure/adapters/unosend', () => ({
...
vi.mock('../../../src/features/email/infrastructure/adapters/mailgun', () => ({
...
vi.mock('../../../src/features/email/infrastructure/adapters/resend', () => ({
