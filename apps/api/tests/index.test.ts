...
import { createMockEnv, createMockKV } from './test-utils/setup';
import type { Env } from '../src/shared/domain/types';

vi.mock('../src/features/auth/infrastructure/http/router', () => {
...
vi.mock('../src/features/tenants/infrastructure/http/router', () => {
  const { Hono } = require('hono');
  return {
...
vi.mock('../src/features/users/infrastructure/http/router', () => {
  const { Hono } = require('hono');
  return {
...
vi.mock('../src/features/storage/infrastructure/http/router', () => {
  const { Hono } = require('hono');
  return {
