import { Link, useNavigate, getRouteApi, createRoute } from '@tanstack/react-router';
...
import { resetPassword } from '@/shared/infrastructure/lib/auth-client';
...
function ResetPasswordPage() {
    ...
    // We use getRouteApi since we know the path will be this
