...
vi.mock('@/shared/infrastructure/ui/button', async () => {
  ...
  return {
    Button: ({ children, variant, className, disabled, onClick, asChild, ...props }: any) => {
...
import { verifyEmailRoute as Route } from '@/features/auth/presentation/routing';
...
describe('Route', () => {
  ...
  it('should have correct route id', () => {
    expect(route.id).toBe('/verify-email');
  });
...
describe('VerifyEmailPage', () => {
  ...
  it('should render loading state initially', async () => {
    ...
    (globalThis as any).__mockVerifyEmail__.mockImplementation(() => new Promise(() => { }));
  ...
  it('should call translation function for verifying state', async () => {
    await act(async () => {
      render(<route.component />);
    });
  ...
  it('should render card with backdrop blur styling', async () => {
    const { container } = await act(async () => render(<route.component />));

    const card = container.querySelector('[data-testid="card"]');
    expect(card?.className).toContain('backdrop-blur-sm');
  });

  it('should render loading state card structure', async () => {
    (globalThis as any).__mockVerifyEmail__.mockImplementation(() => new Promise(() => { }));
  ...
  it('should handle multiple verification attempts', async () => {
    ...
    await act(async () => {
      renderResult = render(<route.component />);
    });
