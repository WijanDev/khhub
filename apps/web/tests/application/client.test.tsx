...
describe('client.tsx', () => {
  ...
  it('should pass StartClient component without props', async () => {
    ...
    // Verify router prop is passed
    expect(reactElement.props).toHaveProperty('router');
    expect((reactElement.props as any).router).toEqual(mockRouter);
  });
